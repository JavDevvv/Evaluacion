...
<div class="container mt-4">
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="p-3 bg-encabezado" style="height: 100%;">
                <!-- Contenido de la barra lateral -->
                <a href="{{ route('listado.index') }}" class="btn btn-info btn-lg mb-3" style="width: 100%;">Listar Libros</a>
                <a href="{{ route('administrar') }}" class="btn btn-primary btn-lg mb-3" style="width: 100%;">Administrar Libro</a>
                <!-- Botón "Nuevo" -->
                <a href="{{ route('libros.create') }}" class="btn btn-info btn-lg" style="width: 100%;">Nuevo</a>
            </div>
        </div>
        <!-- Contenedor de la lista de libros -->
        <div class="col-md-9">
            <h3 class="text-center">Administrador de Libros</h3>
        ...
        <div class="col-md-12 text-center">
            <footer class="footer mt-auto py-3  text-white text-center">
                <span class="text-muted">
                    ...
                    <br>
                    UBP | IS | Programacion Cliente-Servidor | Javier Johan Keme Correa | 3/3/2024   </span>
            </footer>
        </div>
    </div>
</div>
